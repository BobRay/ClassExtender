...
$snippets[1]->setContent(file_get_contents($sources['source_core'] . '/elements/snippets/classextender.snippet.php'));
...
$snippets[2]->setContent(file_get_contents($sources['source_core'] . '/elements/snippets/getextusers.snippet.php'));
...
$snippets[3]->setContent(file_get_contents($sources['source_core'] . '/elements/snippets/getextresources.snippet.php'));
...
$snippets[4]->setContent(file_get_contents($sources['source_core'] . '/elements/snippets/setuserplaceholders.snippet.php'));
...
$snippets[5]->setContent(file_get_contents($sources['source_core'] . '/elements/snippets/setresourceplaceholders.snippet.php'));
...
$snippets[6]->setContent(file_get_contents($sources['source_core'] . '/elements/snippets/extuserupdateprofile.snippet.php'));
...
$snippets[7]->setContent(file_get_contents($sources['source_core'] . '/elements/snippets/usersearchform.snippet.php'));
